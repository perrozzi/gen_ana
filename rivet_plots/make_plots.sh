...
aMC_pythia_50_norm.aida:Scale=$XSEC:ErrorBandColor=red:"Title:aMC@NLO 0,1j + Pyhtia8" \
ZH_merged_norm.yoda:Scale=$XSECBR:ErrorBandColor=red:"Title:aMC@NLO 0,1,2j + Herwig6" \
Sherpa_Hll_inc.yoda:Scale=0.08:"Title:Sherpa-MC@NLO 0j" \
-o inc
rivet-mkhtml \
...
Sherpa_Hll_sel.yoda:Scale=$XSECBR:"Title:Sherpa-MC@NLO 0j" \
