...
powheg/ATLAS.yoda:Scale=0.0098:ErrorBandColor=red:"Title=Powheg + Pythia8" \
NLO_5f/ATLAS.yoda:Scale=0.02175:ErrorBandColor=blue:"Title=aMC@NLO + Pythia8" \
LO_5f/ATLAS.yoda:Scale=0.0137:ErrorBandColor=green:"Title=MG + Pythia8" \
Sherpa_ATLAS.yoda:Scale=0.0121:ErrorBandColor=orange:"Title=Sherpa MEPS@NLO"
...
Sherpa_CMS2.yoda:ErrorBands=1:ErrorBandOpacity=0.2:ErrorBandColor=orange:"Title=Sherpa MEPS@NLO"
...
Sherpa_CMS3.yoda:NormalizeToIntegral=1:ErrorBandColor=orange:"Title=Sherpa MEPS@NLO"
